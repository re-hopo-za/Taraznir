    ...
    <div class="auto-container">
        ...
        <div class="services-info-tabs">
            <div class="services-tabs tabs-box">
                ...
                <div class="content-con" style="display: flex; direction: rtl; flex-wrap: wrap; align-items: center;">
                    <ul class="col-xl-3 col-sm-12 tab-btns tab-buttons clearfix">
                        @if($cats)
                            @foreach($cats as $cat)
                    ...
                    <div class="col-xl-9 col-sm-12 tabs-content">
                        @if($cats)
                            @foreach($cats as $cat)
                                <div
