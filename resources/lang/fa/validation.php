...
return array(
    ...
    */
    ...
    'file' => 'مقدار :attribute بایستی فایل باشد.',
    "size" => array(
    ...
    "captcha" => [
        'fail' => 'کد امنیتی وارد شده معتبر نمی‌باشد',
    ],
    "valid_jalali_date" => " فرمت تاریخ صحیح نمیباشد.",
    "jalali_date_bigger_than" => "مقدارد :attribute کوچکتر از مقدار از تاریخ میباشد. ",
    "valid_last_level_zone" => "منطقه وارد شده دارای زیر منطقه میباشد.",
    'password'                => [
