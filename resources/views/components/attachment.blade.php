    ...
    @if( !empty( $attachments ))
        @foreach( $attachments as $attachment )
            <div class="button-wrap has-icon icon-left size-14 pf21">
                <a href="/pdf-viewer?file={{$attachment->getPath()}}" class="themesflat-button font-default bg-light-white w100 d-flex my-3 flex-row-reverse justify-content-between">
